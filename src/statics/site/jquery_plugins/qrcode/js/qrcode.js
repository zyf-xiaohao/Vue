(function(z) {
    var K = function(h, b, f, n) {
        ...
        M = function(h, b, f, n, c, p, v, k) { h.isDark(v, k) && b.rect(n, c, p, p) },
        ...
        O = function(h) {
            ...
            if (b = G(h.text, h.ecLevel, h.minVersion, h.maxVersion, h.quiet)) {
                var f = h.size,
                    ...
                    v = c(f / p),
                    c = c(.5 * (f - v * p)),
                    k, f = { position: "relative", left: 0, top: 0, padding: 0, margin: 0, width: f, height: f };
                h = { position: "absolute", padding: 0, margin: 0, width: v, height: v, "background-color": h.fill };
                f = z("<div/>").data("qrcode", b).css(f);
                n && f.css("background-color", n);
                for (n = 0; n < p; n += 1)
                    for (k = 0; k < p; k += 1) b.isDark(n, k) && z("<div/>").css(h).css({ left: c + k * v, top: c + n * v }).appendTo(f);
                b = f
            } else b = null;
            return b
        },
        P = { render: "canvas", minVersion: 1, maxVersion: 40, ecLevel: "L", left: 0, top: 0, size: 200, fill: "#000", background: null, text: "no text", radius: 0, quiet: 0, mode: 0, mSize: .1, mPosX: .5, mPosY: .5, label: "no label", fontname: "sans", fontcolor: "#000", image: null };
    z.fn.qrcode = function(h) {
        var b = z.extend({}, P, h);
        return this.each(function() { "canvas" === this.nodeName.toLowerCase() ? H(this, b) : z(this).append(O(b)) })
    };
    var J = function() {
        function h(b, f) {
        ...
        var f = { L: 1, M: 0, Q: 3, H: 2 },
            ...
            x = function() {
                var b = [],
                    c = {
                        writeByte: function(a) { b.push(a & 255) },
            ...
            z = function(b, c) {
                var a = Array(b * c),
                    d = function(a) {
                        ...
                        return {
                            ...
                            flush: function() { 0 < b && a.writeByte(c) }
                        }
                    },
                    f = function() {
                        var a = {},
                ...
                return {
                    setPixel: function(c, d, f) { a[d * b + c] = f },
                    write: function(g) {
