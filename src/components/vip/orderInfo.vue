                                        ...
                                        <div class="order-progress">
                                            <ul>
                                                ...
                                                <li :class="orderinfo.status>=3 ? 'active' : ''">
                                                    ...
                                                    <div class="info">{{ orderinfo.express_time | formatDate('YYYY-MM-DD HH:mm:ss') }}</div>
                                                </li>
                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <a v-if='orderinfo.status==1' href="#/site/goods/payment/12" class="btn-pay">去付款</a>
                                                    <!---->
                                                </dd>
                                            </dl>
                                            <dl class="form-group">
...
<script>
	export default {
		...
		methods:{
			getOrderDetial(){
				this.$axios.get(`site/validate/order/getorderdetial/${this.$route.params.orderid}`).then(response=>{
